...
`MMD_modoki` のドキュメントリンク集です。
用途別に参照しやすいよう、一覧と読み始めガイドをまとめています。
...
- [WebCodecs + MediaBunny で WebM 保存するための調査メモ](./webcodecs-mediabunny-webm-research.md)
...
8. 現行MMDのショートカットを確認したい: `mmd-shortcuts-research.md`
9. 補間曲線の現行実装を確認したい: `interpolation-curve-spec-implementation.md`
10. ボーン編集の現行実装を確認したい: `bone-operation-spec.md`
11. タイムライン実装を確認したい: `timeline-spec.md`
12. UI/Manager/Timelineの接続を確認したい: `data-flow-timeline.md`
13. 再生/停止/シークの状態遷移を確認したい: `edit-state-machine.md`
14. キー保存の内部仕様を確認したい: `keyframe-storage-spec.md`
15. VMD/VPDの読込挙動を確認したい: `import-behavior-vmd-vpd.md`
16. 再生・シークと物理の方針を確認したい: `playback-seek-physics-policy.md`
17. 回帰確認手順を回したい: `manual-test-checklist.md`
18. 未実装/既知課題を確認したい: `known-issues.md`
19. 文字コード/改行の注意点を確認したい: `dev-notes-encoding.md`
