...
更新日: 2026-09-14
状態: ガンマ＋グレインで共通基盤を実装・検証済み。1〜10節は設計時の案、採用範囲と検証結果は11節を参照。後続の[ブルーム複数値キー](./bloom-timeline-key-2026-09-14.md)も実装・検証済み。さらに[数値中心の5種](./scalar-effect-timeline-2026-09-14.md)を追加。11節の未検証範囲は基盤完成時点の記録として残す。
