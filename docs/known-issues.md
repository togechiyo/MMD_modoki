...
- v0.2.0では読み込めるMMD modelが、v0.2.1以降ではmodelを替えても画面が真っ暗になった後にアプリが終了またはcrashする回帰報告が継続しています。コア機能を広範に阻害するP0として、v0.2.0とv0.2.1の版境界、対象形式、配置path、失敗段階、Windows / GPU / backendを調査します。
