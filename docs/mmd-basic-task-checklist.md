...
- [x] 海を除く1エフェクト1行の共通基盤について、状態・保存互換・UI・描画adapter・作業分解を設計し、下準備12〜20h（予備込み16〜26h）と見積もる（[設計・見積もり](./effect-timeline-common-foundation-design-2026-09-14.md)、2026-09-14）。
