...
| adopted | [上級者向け外部WGSLはMMEの名前と用途を参考にする](./decisions/external-wgsl-follows-mme-concepts.md) | BabylonのWGSL基盤とMME風semanticを組み合わせる。コンパイル・読込エラーはPMXと同じviewport通知にする |
