...
| adopted | [上級者向け外部WGSLはMMEの名前と用途を参考にする](./decisions/external-wgsl-follows-mme-concepts.md) | 通常MMDとPBRへの接続。単一WGSL・共通一覧と割当・読込1ボタン・テキスト編集。エラーはviewport通知、フリーズに備えて入力検査と停止・復旧導線を整える |
