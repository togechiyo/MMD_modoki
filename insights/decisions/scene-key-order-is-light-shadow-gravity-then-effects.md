...
source_docs:
  ...
  - ../../docs/aerial-perspective-timeline-2026-09-14.md
superseded_by: null
---
...
所有者は続いて「UIからいま選べるのだけでいい」と範囲を指定した。今後のeffectキー化は現在公開されているUI項目に限定し、没・非表示の効果の復活を含めない。候補名と対象パラメーターは現行UIで確認し、内部IDや古い設計メモだけから推定しない。
