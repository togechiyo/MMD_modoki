...
export function exportProjectState(host: ProjectExportHost): MmdModokiProjectFileV1 {
    ...
    return {
        ...
        effects: {
            ...
            offsetShadowStrength: host.getStaticDepthPostEffects?.().offsetShadow.strength ?? host.postEffectOffsetShadowStrength,
            offsetShadowOffsetX: host.getStaticDepthPostEffects?.().offsetShadow.offsetX ?? host.postEffectOffsetShadowOffsetX,
            offsetShadowOffsetY: host.getStaticDepthPostEffects?.().offsetShadow.offsetY ?? host.postEffectOffsetShadowOffsetY,
            offsetShadowDepthBias: host.getStaticDepthPostEffects?.().offsetShadow.depthBias ?? host.postEffectOffsetShadowDepthBias,
            offsetShadowMaxDepth: host.getStaticDepthPostEffects?.().offsetShadow.maxDepth ?? host.postEffectOffsetShadowMaxDepth,
            offsetShadowDepthScale: host.getStaticDepthPostEffects?.().offsetShadow.depthScale ?? host.postEffectOffsetShadowDepthScale,
            ...
            offsetHighlightEnabled: host.getStaticDepthPostEffects?.().offsetHighlight.enabled ?? host.postEffectOffsetHighlightEnabled,
            offsetHighlightStrength: host.getStaticDepthPostEffects?.().offsetHighlight.strength ?? host.postEffectOffsetHighlightStrength,
            offsetHighlightOffsetX: host.getStaticDepthPostEffects?.().offsetHighlight.offsetX ?? host.postEffectOffsetHighlightOffsetX,
            offsetHighlightOffsetY: host.getStaticDepthPostEffects?.().offsetHighlight.offsetY ?? host.postEffectOffsetHighlightOffsetY,
            ...
            offsetHighlightDepthScale: host.getStaticDepthPostEffects?.().offsetHighlight.depthScale ?? host.postEffectOffsetHighlightDepthScale,
            ...
            directionalLightShaftsStrength: host.getStaticDepthPostEffects?.().directionalLightShafts.strength ?? host.postEffectDirectionalLightShaftsStrength,
            directionalLightShaftsPhaseG: host.getStaticDepthPostEffects?.().directionalLightShafts.phaseG ?? host.postEffectDirectionalLightShaftsPhaseG,
