...
export const FRAME_GRAPH_EFFECT_SLIDER_SPECS = {
    ...
    oceanWaterHeight: { actualMin: -20, actualMax: 20, actualStep: 0.1 },
    oceanWaveHeight: { actualMin: 0, actualMax: 1 },
    oceanWindForce: { actualMin: 0, actualMax: 20, actualStep: 0.1 },
    oceanWaveSpeed: { actualMin: 0, actualMax: 3 },
    oceanBumpHeight: { actualMin: 0, actualMax: 2 },
    ...
    ringParticleCount: { actualMin: 40, actualMax: 320, actualStep: 1 },
    ringParticleDensity: { actualMin: 5, actualMax: 60, actualStep: 0.5 },
    ringParticleSize: { actualMin: 0.05, actualMax: 1 },
    ringParticleSpeed: { actualMin: 0, actualMax: 0.5 },
    ringParticleIntensity: { actualMin: 0, actualMax: 4 },
